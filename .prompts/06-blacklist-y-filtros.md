...
- Ruta del fichero vía variable de entorno (p. ej. `BLACKLIST_DB_PATH`) con default razonable en desarrollo; documentar que en serverless puro el fichero puede no ser adecuado (si aplica al hosting del usuario).
