...
import {
  ...
  saveSettingsToDexie,
  wipeLocalKidstubeStoresKeepAppSettings,
...
export default function ParentalSettingsPage() {
  ...
  const wipeAll = async () => {
    ...
    try {
      ...
      await wipeLocalKidstubeStoresKeepAppSettings(settingsSnapshot);
