...
En `peketube/.env.local` añade **al menos** (genera un valor aleatorio):
...
Cierra otros `next dev` que tengas en el mismo proyecto (mismo `peketube/`).
...
Ver `../.prompts/` en la raíz del repo PekeTube.
